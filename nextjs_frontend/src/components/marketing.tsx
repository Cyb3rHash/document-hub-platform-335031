...
function NavLink({ href, children }: { href: string; children: React.ReactNode }) {
  return (
    <Link href={href} className="relative text-sm font-medium text-gray-700">
      <span className="transition hover:text-gray-900">{children}</span>
      <motion.span
        layoutId="nav-underline"
        className="absolute -bottom-2 left-0 right-0 h-px origin-left bg-gray-900/60"
        initial={{ scaleX: 0 }}
        whileHover={{ scaleX: 1 }}
                  ...
                  {[
                    ...
                    >
                      <div className="min-w-0">
                        ...
                        <p className="text-xs text-gray-600">{row.meta}</p>
                      </div>
...
function Stat({
  ...
  return (
    <div className="flex items-center gap-3 rounded-2xl border border-gray-200 bg-white/70 px-4 py-3 shadow-sm backdrop-blur">
