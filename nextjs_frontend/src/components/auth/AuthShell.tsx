...
export function AuthShell({
  ...
  /** Two-panel auth layout with animated accent panel. */
...
function Panel({
  ...
  return (
    ...
    >
      <motion.div
        initial={false}
        animate={{ opacity: active ? 1 : 0.85, y: active ? 0 : 4 }}
      ...
      {/* subtle overlay for inactive panel */}
      {!active && (
        <div className="pointer-events-none absolute inset-0 rounded-2xl bg-gray-50/30" />
      )}

      {/* hint alignment difference */}
