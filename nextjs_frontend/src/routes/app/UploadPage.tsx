...
import { faCloudArrowUp, faFileArrowUp, faTriangleExclamation, faCheck } from "@fortawesome/free-solid-svg-icons";
        ...
        <Card className="lg:col-span-2">
          ...
          <CardBody>
            <motion.div
              ...
              className={cn("relative rounded-2xl border border-dashed bg-gray-50 px-6 py-10 text-center", "border-gray-200")}
            >
